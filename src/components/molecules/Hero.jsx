		   ...
		   <div class="flex flex-col items-center pt-5 mx-auto w-full sm:flex-row sm:justify-around sm:w-auto sm:pt-8">
            ...
            <div className="sm:ml-10 xs:text-center sm:text-left md:text-left">
                ...
                <div class="buttons mt-7">
                        <a href="#" className="px-5 py-3 border rounded-lg bg-white text-[#141517] hover:border-slate-400 shadow-lg hover:bg-[#1A1B1F] hover:text-slate-200 hover:border" onclick="smoothScroll('follow')" target="blank">Follow Me</a>
