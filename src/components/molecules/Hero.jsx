        ...
        <>
		   ...
		   <div className="flex flex-col items-center pt-5 mx-auto w-full sm:flex-row sm:justify-around sm:w-auto sm:pt-8">
            <article className="sm:ml-10 xs:text-center sm:text-left md:text-left">
                <h1 className="text-base font-[600] text-primary md:text-xl mt-10 md:mt-0">Hello 👋, I'm <span className="mt-1 block text-4xl font-[700] text-white dark:text-[#364252] lg:text-5xl">Rekun-dev</span></h1>
